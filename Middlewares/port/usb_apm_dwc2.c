...
uint8_t g_usb_ep_num[CONFIG_USBDEV_MAX_BUS] = {
	 [0] = 4 // #TASK Port.A support 4 endpoint
	,[1] = 6 // #TASK Port.B support 6 endpoint
};
...
// USB_OTG_FS_PERIPH_BASE
	...
	*/
	...
	extern uint32_t usbd_get_dwc2_gccfg_conf(uint32_t reg_base);
...
extern uint8_t usbd_get_speed_config(uint8_t busid, uint8_t fsphy_type, uint8_t hsphy_type);
